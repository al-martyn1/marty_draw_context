...
std::unordered_map< std::string, std::string > makeMimeTypesMap();

inline
const std::unordered_map< std::string, std::string >& getMimeTypes()
{
    static std::unordered_map< std::string, std::string > m = makeMimeTypesMap();
    return m;
}
...
std::string getMimeTypeByExt(std::string ext)
{
    ...
    ext = marty_cpp::toLower(ext);

    const std::unordered_map< std::string, std::string > &m = getMimeTypes();
    std::unordered_map< std::string, std::string >::const_iterator it = m.find(ext);
