...
public:
    ...
    virtual bool drawImageScaled( IImageList                 *pImgList, int idx, const DrawCoord &pos, const DrawCoord &imgScreenSize, ImageSize imgPartLeftTop, ImageSize imgPartSize) override { return getActiveDc()->drawImageScaled(pImgList, idx, pos, imgScreenSize, imgPartLeftTop, imgPartSize); };
    virtual bool drawImageScaled( std::shared_ptr<IImageList> pImgList, int idx, const DrawCoord &pos, const DrawCoord &imgScreenSize, ImageSize imgPartLeftTop, ImageSize imgPartSize) override { return getActiveDc()->drawImageScaled(pImgList, idx, pos, imgScreenSize, imgPartLeftTop, imgPartSize); };
