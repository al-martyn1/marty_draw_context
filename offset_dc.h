...
/*! В базовом IDrawContext также есть смещение, но там оно задаётся в пикселях и без учета масштабирования. 
    ...
    современных канвасах, но тут такой нюанс, там смещение в пикселях относительно системной поверхности рисования,
    без учета масштабирования. В данном классе смещение с учетом масштабирования, если такое втащить в базовую реализацию, будет путанница.
